...
- отключить возможность переноса строки в поле ввода имени и добавить проверку на длину строки;
...
- некорректное отображение индикаторов отпуска на календаре в браузерах на базе webkit (смещение на одну позицию);
